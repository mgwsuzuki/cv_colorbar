...
CONFIG.FREQ_HZ {65000000} \
  ...
  set clk10x [ create_bd_port -dir O -type clk clk10x ]
  set_property -dict [ list \
...
CONFIG.C_SIZE {1} \
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_ports clk10x] [get_bd_pins clk_wiz_0/clk_out2]
  ...
  connect_bd_net -net resetn_1 [get_bd_ports resetn] [get_bd_pins util_vector_logic_0/Op2]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins clk_wiz_0/resetn] [get_bd_pins util_vector_logic_0/Res]
